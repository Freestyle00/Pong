...
{
    public partial class HUD : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Graphics.IVisible
    {
        ...
        public int TextInstanceDisplayText
        {
            get
            {
    ...
    {
        public static void SetVisible (this FlatRedBall.Math.PositionedObjectList<HUD> list, bool value) 
        {
