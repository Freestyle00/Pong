...
{
    public partial class Player2 : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        protected static Microsoft.Xna.Framework.Graphics.Texture2D player_skin;
        ...
        public Player2 (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public Player2 (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public virtual void PostInitialize () 
        {
            ...
            if (SpriteInstance.Parent == null)
            {
                SpriteInstance.X = -110f;
            }
            else
            {
                SpriteInstance.RelativeX = -110f;
            }
            SpriteInstance.Texture = player_skin;
            ...
            {
                AxisAlignedRectangleInstance.X = -110f;
            }
            else
            {
                AxisAlignedRectangleInstance.RelativeX = -110f;
            }
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("Player2StaticUnload", UnloadStaticContent);
                        mRegisteredUnloads.Add(ContentManagerName);
                    }
                }
                if (!FlatRedBall.FlatRedBallServices.IsLoaded<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/player2/player_skin.png", ContentManagerName))
                {
                    registerUnload = true;
                }
                player_skin = FlatRedBall.FlatRedBallServices.Load<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/player2/player_skin.png", ContentManagerName);
            }
