...
{
    public partial class Player1 : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public Player1 (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public virtual void PostInitialize () 
        {
            ...
            if (SpriteInstance.Parent == null)
            {
                SpriteInstance.X = 100f;
            }
            else
            {
                SpriteInstance.RelativeX = 100f;
            }
            ...
            {
                AxisAlignedRectangleInstance.X = 100f;
            }
            else
            {
                AxisAlignedRectangleInstance.RelativeX = 100f;
            }
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("Player1StaticUnload", UnloadStaticContent);
                        mRegisteredUnloads.Add(ContentManagerName);
                    }
                }
                if (!FlatRedBall.FlatRedBallServices.IsLoaded<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/player1/player_skin.png", ContentManagerName))
                {
                    registerUnload = true;
                }
                player_skin = FlatRedBall.FlatRedBallServices.Load<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/player1/player_skin.png", ContentManagerName);
            }
