...
namespace PongNewTry.Screens
{
    public partial class GameScreen : FlatRedBall.Screens.Screen
    {
        ...
        private PongNewTry.Entities.Border BorderInstance;
        ...
        public event System.Action<PongNewTry.Entities.PongBall, PongNewTry.Entities.Border> PongBallInstanceVsBorderInstanceCollisionOccurred;
        public GameScreen () 
        	: base ("GameScreen")
        {
        }
    ...
    PongBallInstanceVsPlayer2Instance.SetBounceCollision(0f, 1f, 2f);
        ...
        public override void AddToManagers () 
        {
            ...
            BorderInstance.AddToManagers(mLayer);
        ...
        public virtual void PostInitialize () 
        {
            ...
            if (BorderInstance.Parent == null)
            {
                BorderInstance.X = 250f;
            }
            else
            {
                BorderInstance.RelativeX = 250f;
            }
            if (BorderInstance.Parent == null)
            {
                BorderInstance.Y = 0f;
        ...
        public virtual void RemoveFromManagers () 
        {
            ...
            BorderInstance.RemoveFromManagers();
        ...
        public virtual void AssignCustomVariables (bool callOnContainedElements) 
        {
            if (callOnContainedElements)
            {
                ...
                BorderInstance.AssignCustomVariables(true);
        ...
        public virtual void ConvertToManuallyUpdated () 
        {
            ...
            BorderInstance.ConvertToManuallyUpdated();
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            PongNewTry.Entities.Border.LoadStaticContent(contentManagerName);
